...
df_data.loc[~df_data.index.isin(news_countries)].sort_values('testing_bias.change')[[
    'affected_ratio.miss', 'needICU.per100k.miss', 'infection_rate.change', 'testing_bias.change',
    'infection_rate', 'infection_rate_past', 'affected_ratio.est', 'needICU.per100k', 
]].T
